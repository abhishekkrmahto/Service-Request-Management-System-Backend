...
const CATEGORIES = [
  {
    ...
    label: "Electronics",
    icon: "💻",
    desc: "Laptop, TV, Phone, AC repairs",
  },
  {
    id: "plumbing",
    label: "Plumbing",
    icon: "🔧",
    desc: "Pipes, taps, drainage, leaks",
  },
  {
    id: "electrical",
    label: "Electrical",
    icon: "⚡",
    desc: "Wiring, fans, switches, fixtures",
  },
  {
    id: "carpentry",
    label: "Carpentry",
    icon: "🪚",
    desc: "Doors, windows, furniture repair",
  },
  {
    id: "cleaning",
    label: "Cleaning",
  ...
  },
  {
    ...
    label: "Painting",
    icon: "🎨",
    desc: "Wall painting, touch-ups",
  },
  {
    id: "appliance",
    label: "Appliances",
    icon: "🏠",
    desc: "Fridge, washing machine, geyser",
  },
...
const INIT_REQUESTS = [
  {
    ...
    description:
      "Need a laptop repairing serviceman — keyboard not working after spill.",
    status: "pending",
    createdAt: "2025-06-10 09:14",
    priority: "high",
    assignedTo: null,
    updatedAt: "2025-06-10 09:14",
  },
  {
    id: "SRV-008",
    service: "Geyser Not Working",
    category: "Appliances",
    description: "Hot water geyser stopped heating. No hot water since 2 days.",
    status: "assigned",
    createdAt: "2025-06-09 16:00",
    priority: "medium",
    assignedTo: "Vikram Nair",
    updatedAt: "2025-06-10 08:30",
  },
  {
    id: "SRV-009",
    service: "Paint Living Room",
    category: "Painting",
    description: "Living room walls need fresh coat of paint. Area ~400 sq ft.",
    status: "completed",
    createdAt: "2025-06-05 10:00",
    priority: "low",
    assignedTo: "Rahul Verma",
    updatedAt: "2025-06-07 17:00",
  },
];
          ...
          >
            <div
              style={{
                ...
                fontSize: "0.7rem",
                fontWeight: 700,
                color: current >= s.step ? "#fff" : COLORS.muted,
                flexShrink: 0,
              }}
            >
            ...
            <div
              style={{
                fontSize: "0.65rem",
                color: current >= s.step ? COLORS.accent : COLORS.muted,
                whiteSpace: "nowrap",
                textAlign: "center",
              }}
            >
...
export default function UserPage({ onLogout }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch("http://localhost:8000/createService", {
        method: "POST",
        headers: {
        ...
        body: JSON.stringify({
          ...
          serviceType: CATEGORIES.find((c) => c.id === selectedCategory)?.label,
          priority:
            form.priority === "low" ? 1 : form.priority === "medium" ? 2 : 3,
          status: "pending",
        ...
        >
          <div>
            ...
            <p style={{ margin: 0, fontSize: "0.78rem", color: COLORS.muted }}>
              {activeTab === "raise"
                ? "Tell us what you need — we'll send the right person"
                : "Track all your raised requests in one place"}
            </p>
          </div>
                  ...
                  {CATEGORIES.map((cat) => (
                    <div
                      ...
                      style={{
                        ...
                        padding: "1rem",
                        cursor: "pointer",
                        border: `1px solid ${selectedCategory === cat.id ? COLORS.accent : "rgba(99,118,160,0.2)"}`,
                        background:
                  ...
                  <form onSubmit={handleSubmit}>
                    ...
                    <div style={{ marginBottom: "1rem" }}>
                      ...
                      <input
                        name="service"
                        required
                        placeholder={`e.g., ${CATEGORIES.find((c) => c.id === selectedCategory)?.desc.split(",")[0]} repair`}
                        value={form.service}
                        onChange={handleFormChange}
                      ...
                      >
                        ...
                        >
                          ...
                          <span
                            style={{
                              fontSize: "0.75rem",
                              color: PRIORITY_META[form.priority]?.color,
                              fontWeight: 600,
                            }}
                          >
                    ...
                    <button
                      type="submit"
                      disabled={
                        submitting || !form.service || !form.description
                      }
                      style={{
      ...
      {detailReq && (
        ...
        >
          ...
          >
            ...
            >
              <Badge
                label={STATUS_META[detailReq.status]?.label}
                color={STATUS_META[detailReq.status]?.color}
                bg={STATUS_META[detailReq.status]?.bg}
              />
              <Badge
                label={PRIORITY_META[detailReq.priority]?.label}
                color={PRIORITY_META[detailReq.priority]?.color}
                bg={`${PRIORITY_META[detailReq.priority]?.color}18`}
              />
            </div>
              ...
              >
                ...
                <span
                  style={{
                    ...
                    fontWeight: 600,
                    color:
                      label === "Assigned To" && detailReq.assignedTo
                        ? COLORS.success
                        : COLORS.text,
                  }}
                >
