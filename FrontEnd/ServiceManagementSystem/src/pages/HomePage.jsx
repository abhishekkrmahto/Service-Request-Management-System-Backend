  ...
  return (
    ...
    >
      ...
      >
        ...
        <div style={{ display: "flex", gap: "1.5rem", fontSize: "0.9rem", color: COLORS.muted }}>
          <a href="#features" style={{ color: COLORS.muted, textDecoration: "none" }}>Features</a>
          <a href="#stats" style={{ color: COLORS.muted, textDecoration: "none" }}>Stats</a>
          <a href="#auth" style={{ color: COLORS.accent, textDecoration: "none", fontWeight: 600 }}>Login</a>
        </div>
      </nav>
      ...
      >
        ...
        >
          ServiceHub connects users, admins, and servicemen in a seamless workflow — from raising a
          request to marking it complete.
        </p>
      ...
      >
        ...
        <div id="features" style={{ flex: "1 1 420px" }}>
          ...
          >
            ...
            {[
              { role: "User", color: COLORS.accent2, desc: "Raise and track service requests" },
              { role: "Admin", color: "#a855f7", desc: "Manage requests, assign servicemen" },
              { role: "Serviceman", color: COLORS.success, desc: "View tasks, update completion status" },
            ].map((r) => (
              <div
                key={r.role}
                style={{
              ...
              >
                ...
                />
                <span style={{ fontWeight: 600, fontSize: "0.88rem", minWidth: "90px", color: r.color }}>
                  {r.role}
                </span>
                <span style={{ color: COLORS.muted, fontSize: "0.85rem" }}>{r.desc}</span>
              </div>
            ))}
          </div>
        </div>
        ...
        {/* Auth Card */}
        <div id="auth" style={{ flex: "0 0 380px", maxWidth: "100%" }}>
          <div style={{ ...glassCard, padding: "2rem" }}>
            ...
            <div style={{ marginBottom: "1.25rem" }}>
              <label style={{ fontSize: "0.8rem", color: COLORS.muted, marginBottom: "0.4rem", display: "block" }}>
                Sign in as
              </label>
              <div style={{ display: "flex", gap: "0.5rem" }}>
                {["user", "admin", "serviceman"].map((r) => {
                  const colors = {
                    user: COLORS.accent2,
                    admin: "#a855f7",
                  ...
                  return (
                    <button
                      ...
                      style={{
                        ...
                        borderRadius: "0.5rem",
                        background: role === r ? `${colors[r]}18` : "transparent",
                    ...
                    >
                      {r === "user" ? "👤 User" : r === "admin" ? "👑 Admin" : "🔧 Serviceman"}
                    </button>
                  );
                })}
              </div>
            ...
            <form onSubmit={handleSubmit}>
              ...
              {tab === "register" && (
                <div style={{ marginBottom: "1rem" }}>
                  ...
                  <input
                    ...
                    style={{
                      ...inputStyle,
                      borderColor: focusField === "name" ? COLORS.accent : COLORS.border,
                    }}
                  />
                </div>
              )}
              ...
              <div style={{ marginBottom: "1rem" }}>
                ...
                <input
                  ...
                  style={{
                    ...inputStyle,
                    borderColor: focusField === "email" ? COLORS.accent : COLORS.border,
                  }}
                />
              </div>
              ...
              <div style={{ marginBottom: "1rem" }}>
                ...
                <input
                  ...
                  style={{
                    ...inputStyle,
                    borderColor: focusField === "password" ? COLORS.accent : COLORS.border,
                  }}
                />
              </div>
              ...
              {tab === "register" && (
                <div style={{ marginBottom: "1rem" }}>
                  ...
                  <input
                    ...
                    style={{
                      ...inputStyle,
                      borderColor: focusField === "confirm" ? COLORS.accent : COLORS.border,
                    }}
                  />
                </div>
              )}
              ...
              {tab === "login" && (
                <div style={{ textAlign: "right", marginBottom: "1rem" }}>
                  <a href="#" style={{ fontSize: "0.82rem", color: COLORS.accent, textDecoration: "none" }}>
                    Forgot password?
                  </a>
                </div>
              )}
          ...
          >
            💡 Demo mode: select a role above and click Sign In to explore the dashboard.
          </div>
        </div>
      </section>
      ...
      >
        ...
        <span style={{ display: "flex", gap: "1.5rem" }}>
          ...
          <a href="#" style={{ color: COLORS.muted, textDecoration: "none" }}>Support</a>
        </span>
      </footer>
    </div>
  );
